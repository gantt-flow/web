        ...
        <div className="flex flex-row h-screen">
            ...
            <div className="flex flex-col basis-1/2">
                ...
                <div className="flex flex-col w-2/3 self-center mt-30">
                    <h1 className="text-[36px]">Registrate para continuar</h1>
                ...
                <p className="mt-4 text-center">¿Ya tienes una cuenta? <a href="/auth/login" className="hover:underline">Inicia sesión aquí</a></p>
            </div>
